    ...
    "house": [
        {
            ...
            "bathroom": 2,
            "bedroom": 3,
            "description": "Casa Verde, a house with a modern design and enough land area for family life. With two bathrooms and three bedrooms, this house provides comfort and warmth for your family.",
            "price":"700Jt-an",
            "carport":"1",
        ...
        },
        {
            ...
            "bathroom": 3,
            "bedroom": 4,
            "description": "Sky Villa, a luxury home with stunning views. With three bathrooms and four bedrooms, this is the perfect place to live in style and relax above the blue sky.",
            "price":"800Jt-an",
            "carport":"1",
            "plan_house":"./img/denah_rumah.jpg"
        },
        {
            ...
            "bathroom": 4,
            "bedroom": 5,
            "description": "Lakeview Mansion, a magnificent home with stunning lake views. With four bathrooms and five bedrooms, this home brings elegance and comfort to a prestigious lifestyle.",
            "price":"900Jt-an",
            "carport":"1",
            "plan_house":"./img/denah_rumah.jpg"
        },
        {
            ...
            "bathroom": 2,
            "bedroom": 3,
            "description": "Garden Retreat, an elegant home with beautiful gardens. Two bathrooms and three bedrooms provide the perfect balance between natural beauty and modern home comforts.",
            "price":"950Jt-an",
            "carport":"1",
            "plan_house":"./img/denah_rumah.jpg"
        }
...
function createHouseCard(house, index, isMobileView) {
    ...
    return isMobileView
        ...
        `
        : isOdd ? imageHouse + explanation : explanation + imageHouse;
}
...
function filterHouseByType(type) {
    return jsonData.house.find((house) => house.type.toUpperCase() === type.toUpperCase()) || null;
}
...
if (typeHouseValue) {
    ...
    if (filteredHouse) {
        document.getElementById("title-name-house").innerText = `House ${filteredHouse.name}`;
        ...
        document.getElementById("description-house").innerText = filteredHouse.description;
        document.getElementById("price-house").innerText = filteredHouse.price;
        document.getElementById("building-size").innerText = `${filteredHouse.building_size}m²`;
        document.getElementById("surface-area").innerText = `${filteredHouse.surface_area}m²`;
        document.getElementById("bathroom-house").innerText = filteredHouse.bathroom;
...
const blogData = [
    {
        ...
        description: "Discover the ultimate destination for families at HouseGreen Residence. A place where comfort meets connection, offering serene spaces to create lasting memories with your loved ones...",
    ...
    },
    {
        ...
        description: "Experience comfort and cleanliness in our thoughtfully designed restrooms. At HouseGreen Residence, we prioritize hygiene and convenience, ensuring that our toilets are well-maintained and equipped with modern amenities...",
    ...
    },
    {
        ...
        description: "Step into tranquility with our beautifully landscaped garden, designed to offer a peaceful retreat for relaxation and reflection. Surrounded by lush greenery and vibrant flowers, the garden at HouseGreen Residence is a haven for nature lovers...",
    ...
    },
    {
        ...
        description: "Our children's room is a vibrant, imaginative space designed for fun and learning. With bright colors, playful decor, and plenty of room to explore, this room is the perfect environment for your little ones to grow, play, and dream...",
    ...
    },
    {
        ...
        description: "Our modern kitchen is designed to be both functional and stylish, with sleek countertops, state-of-the-art appliances, and ample storage space. It is a perfect blend of comfort and convenience, where cooking becomes a joy and every meal is an experience...",
        detail_blog: "./content/blog-4.html",
...
function renderBlogPosts(filteredBlogData, isFiltered) {
    ...
    if (latestBlogContent != null) {
        ...
        const sortedLatestPosts = blogData
            .sort((a, b) => new Date(b.updatedAt || b.date) - new Date(a.updatedAt || a.date)) // Newest first
    ...
    const sortedMainContentPosts = (isFiltered ? filteredBlogData : blogData)
        .sort((a, b) => new Date(b.updatedAt || b.date) - new Date(a.updatedAt || a.date)); // Newest first
